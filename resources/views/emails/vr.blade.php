...
<div class="email-container">
    ...
    <div class="content">
        ...
        <p>You are receiving this email for <strong>Vendor Master Data Validation <span style="color: red;">Rejected</span></strong>. </p>
        ...
        <div class="info-box">
            ...
            <p style="margin-bottom: 0;"><strong>Vendor Name:</strong> {{ $details['business_name'] }}</p>
        </div>
