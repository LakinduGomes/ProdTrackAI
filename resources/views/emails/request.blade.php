...
<div class="email-container">
    <div class="header">
        <h1 style="font-color: #0a53be">Vendor Request</h1>
    </div>

    <div class="content">
        <h3>Dear {{ $details['business_name'] }},</h3>

        <p>We need to register your company in our system. Please kindly fill and submit the form in following URL</p>


        <a href="{{ $details['login_link'] }}" class="button">Click Here to Fill the Form</a>
