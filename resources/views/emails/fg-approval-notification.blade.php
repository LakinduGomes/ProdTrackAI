...
<div class="email-container">
    ...
    <div class="content">
        ...
        <p>You're receiving this message for <strong>Technical Master Data Validation</strong>. Kindly review and take action on the following:</p>
        ...
        <div class="signature">
            <p>Best regards,<br><strong>MDM Team</strong></p>
        </div>
    </div>

    <div class="footer">
        <p>If you need assistance, reach us at <a href="mailto:masterdata@ceatsrilanka.com">masterdata@ceatsrilanka.com</a>.</p>
        <p>&copy; {{ date('Y') }} CEAT. All rights reserved.</p>
    </div>
</div>
</body>
</html>
