...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_fg_trading', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('division')->references('code')->on('tbl_master_material_division')->onUpdate('cascade')->onDelete('cascade');
            ...
            $table->string('volume',10,2)->nullable();
            $table->string('nsd',10,2)->nullable();
            //Technical Data
            ...
            $table->integer('level2_user')->nullable();
            //add two columns to current level and next level according to the workflow
    ...
    {
        Schema::dropIfExists('tbl_fg_trading');
    }
};
