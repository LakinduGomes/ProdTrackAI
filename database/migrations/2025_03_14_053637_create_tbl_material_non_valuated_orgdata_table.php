...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_material_non_valuated_orgdata', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('non_valuated_id');
            $table->foreign('non_valuated_id')->references('id')->on('tbl_material_non_valuated')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tbl_material_non_valuated_orgdata');
    }
};
